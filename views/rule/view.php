...
$this->addBreadcrumb($rule->getName());
        ...
        <div class="row">
            <div class="col-12">
                <div class="float-right">
                    <a class="btn btn-info mx-sm-1 mb-2" href="<?= $urlGenerator->generate('/rbac/rule/edit', ['name' => $rule->getName()]) ?>">
                        <?= Icon::widget()->options(['class' => 'mr-1'])->name('edit'); ?>
                        Update
                    </a>
                    <?= Html::a(
                        Icon::widget()->name('delete') . ' Delete',
                        $urlGenerator->generate('/rbac/rule/delete', ['name' => $rule->getName()]),
                        [
                            'is' => 'link',
